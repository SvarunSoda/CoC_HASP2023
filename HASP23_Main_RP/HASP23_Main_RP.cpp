...
const float ExposureTimeScience = 1;					// (ms) Exposure time of science camera
const int GainGuide = 200;
const int GainScience = 0;
...
const float CaptureDelay = .2;							// (sec) Delay between each camera capture
